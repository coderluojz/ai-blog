---
title: 'webpack 基础知识'
description: '什么是webpack？webpack是静态模块打包器，当webpack处理应用程序时，会将所有这些模块打包成一个或者多个文件。'
pubDate: 2021-05-14
updatedDate: 2021-05-14
category: '工程化'
tags: ['webpack']
aiSummary: '本文介绍了 Webpack 的核心概念，包括入口 (entry)、出口 (output)、加载器 (loader) 和插件 (plugins)。通过详细的代码示例展示了单/多入口配置、CSS/图片处理以及开发服务器的搭建，是 Webpack 入门的实用指南。'
draft: false
---
