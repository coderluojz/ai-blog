---
title: 'Pinia？看这篇就够了！'
description: 'Pinia本质上依然是一个全局状态管理的库，用于跨组件、页面进行状态共享（这点和Vuex、Redux、Mobx一样）。'
pubDate: 2023-02-27
updatedDate: 2023-02-27
category: '前端开发'
tags: ['vue', 'pinia']
aiSummary: '本文全面介绍了 Vue3 的新一代状态管理库 Pinia。对比了其与 Vuex 的区别，讲解了核心概念 State、Getters、Actions 的定义与使用，并总结了其在 TypeScript 支持和 API 简化方面的优势。'
draft: false
---
