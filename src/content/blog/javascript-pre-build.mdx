...
description: '通过实例详细讲解 JavaScript 在函数体和全局作用域中的预编译流程，理清变量提升与函数提升的顺序。'
pubDate: 2021-12-14
updatedDate: 2021-12-14
category: 'JavaScript'
tags: ['JavaScript', '预编译']
aiSummary: '本文揭秘了 JavaScript 的预编译底层机制。通过对函数内部和全局环境两个维度的分析，拆解了找形参、找变量、找函数声明及顺序执行的完整步骤，帮助开发者深入理解提升（Hoisting）的本质。'
draft: false
---
